...
ALTER TABLE "scheduled_tasks" ADD COLUMN "content_mode" TEXT NOT NULL DEFAULT 'off';

-- Migrate existing auto_generate values
UPDATE "scheduled_tasks" SET "content_mode" = 'auto_generate' WHERE "auto_generate" = true;
...
CREATE INDEX "topic_queue_agency_client_idx"    ON "topic_queue"("agency_id", "client_id");
CREATE INDEX "topic_queue_client_vertical_idx"  ON "topic_queue"("client_id", "vertical_id");
...
CREATE TABLE "topic_preference_log" (
  "id"               TEXT NOT NULL,
  "agency_id"        TEXT NOT NULL,
  "client_id"        TEXT NOT NULL,
  "vertical_id"      TEXT,
...
CREATE INDEX "topic_pref_log_client_vertical_idx" ON "topic_preference_log"("client_id", "vertical_id");
CREATE INDEX "topic_pref_log_agency_idx"           ON "topic_preference_log"("agency_id");
