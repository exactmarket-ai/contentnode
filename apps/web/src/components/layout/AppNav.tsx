  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute right-0 top-[64px] z-10 flex h-12 w-3 items-center justify-center rounded-l-sm border border-r-0 border-border bg-card hover:bg-muted transition-colors"
      >
        {collapsed
