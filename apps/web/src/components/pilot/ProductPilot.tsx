        ...
        <div className="flex items-center gap-1.5">
          ...
          {saved ? (
            ...
            <button
              onClick={handleSave}
              disabled={saving}
              className="flex items-center gap-1 rounded-md px-2 py-1 text-[10px] font-semibold text-white bg-primary hover:bg-primary/90 disabled:opacity-50 transition-colors"
            >
...
function SkillSuggestionCard({
  ...
  return (
    <div className="rounded-xl border border-border bg-white p-3 space-y-1.5 hover:border-primary/30 transition-colors">
      <div className="flex items-start justify-between gap-1">
        <span className="text-[11px] font-semibold text-foreground leading-snug">{suggestion.name}</span>
        <Icons.ArrowRight className="h-3 w-3 text-primary/40 shrink-0 mt-0.5" />
      </div>
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          activeTemplateId === t.id
                            ...
                            : 'border-border bg-zinc-50 text-foreground hover:border-primary/30 hover:bg-primary/5',
                        )}
                      >
              ...
              <div className="flex flex-col gap-2 w-full max-w-xs">
                {starters.map((s) => (
                  <button
                    ...
                    className="rounded-xl border border-border bg-zinc-50 px-4 py-2.5 text-[11px] font-medium text-foreground hover:border-primary/30 hover:bg-primary/5 transition-colors text-left"
                  >
                    {s}
                  </button>
                ))}
