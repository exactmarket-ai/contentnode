...
Return ONLY the rewritten text. No preamble, no explanation.`,
  ...
  // ─── Video Storyboard Generator ─────────────────────────────────────────────
  {
    ...
    description:
      'Upload a .docx video script, let Claude parse it into scenes, generate per-scene image prompts, create AI frames with GPT Image 1 (parallel), and assemble a branded A4-landscape PDF storyboard.',
    category: 'video',
    icon: 'Film',
    nodes: [
      {
      ...
      },
      {
        ...
        data: {
          label: 'Scene Parser (AI)',
          subtype: 'storyboard-scene-parser',
          config: { subtype: 'storyboard-scene-parser' },
        },
      },
      {
        id: 'vsb-prompts',
        ...
        data: {
          ...
          subtype: 'storyboard-image-prompt-builder',
          config: {
            subtype: 'storyboard-image-prompt-builder',
            clientName: '',
            verticalName: '',
    ...
    edges: [
      { id: 'e-vsb-1', source: 'vsb-docx',    target: 'vsb-parser'  },
      { id: 'e-vsb-2', source: 'vsb-parser',  target: 'vsb-prompts' },
      { id: 'e-vsb-3', source: 'vsb-prompts', target: 'vsb-framegen' },
      { id: 'e-vsb-4', source: 'vsb-framegen', target: 'vsb-pdf'    },
    ],
  },
]
