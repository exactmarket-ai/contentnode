  ...
  app.get<{ Params: { id: string } }>('/:id', async (req, reply) => {
    ...
    return reply.send({
      data: {
        ...
        clientFolderBox: (run as unknown as Record<string, unknown>).clientFolderBox ?? null,
        mondayItemId: (run as unknown as Record<string, unknown>).mondayItemId ?? null,
        mondayBoardId: (run as unknown as Record<string, unknown>).mondayBoardId ?? null,
